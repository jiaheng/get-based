...
import { loadContextHealthDots, closeSuggestionsOnClickOutside } from './context-cards.js';
...
import { createDashboardWidgetRegistry, DASHBOARD_WIDGET_SOURCE_ORDER, DASHBOARD_MANUAL_BIOMETRIC_METRICS, dashboardBiometricSelectionKey } from './dashboard-widgets.js';
...
const dashboardWidgetRegistry = createDashboardWidgetRegistry({
  ...
  isOrganizeMode: () => _dashboardOrganizeMode,
});
