...
css/*.css           — Split feature CSS for high-churn surfaces such as mobile dashboard, menstrual cycle, client list, chat panel, wearables, Light/Sun, and redesign catch-up
