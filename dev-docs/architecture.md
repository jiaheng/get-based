...
css/*.css           — Split shared/feature CSS for category views, modal utilities, and high-churn surfaces such as settings, mobile dashboard, menstrual cycle, marker detail modal, client list, chat panel, wearables, Light/Sun, and redesign catch-up
