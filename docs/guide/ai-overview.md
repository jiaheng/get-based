...
| **Context-card AI dots** | 9 dashboard cards (Health Goals, Diet, Exercise, Sleep, Light & Circadian, Stress, Love Life, Environment, Medical Conditions) | A health-dot + 8-word tip per card, summarizing whether the card's filled-in content supports or undermines your stated goals. Manual ↻ refresh. |
