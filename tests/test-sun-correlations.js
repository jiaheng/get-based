...
// Run: fetch('tests/test-sun-correlations.js').then(r=>r.text()).then(s=>Function(s)())
...
return (async function() {
  ...
  console.log('%c Sun Correlations Tests ', 'background:#f59e0b;color:#fff;font-size:14px;padding:4px 12px;border-radius:4px');

  const mod = await import('/js/sun-correlations.js?bust=' + Date.now());
  ...
  console.log(`%c Sun Correlations: ${pass} passed, ${fail} failed `,
