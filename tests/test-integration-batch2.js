...
console.log('=== Integration Tests — Batch 2 Fixes ===\n');
  ...
  const css = ['styles.css', 'css/import.css', 'css/modal-shared.css', 'css/context-profile.css', 'css/data-protection.css', 'css/chat-panel.css', 'css/chat-personality.css', 'css/chat-messages.css', 'css/chat-composer.css', 'css/chat-onboarding.css', 'css/chat-responsive.css', 'css/chat-actions.css', 'css/chat-mobile.css', 'css/chat-redesign.css'].map(read).join('\n');
